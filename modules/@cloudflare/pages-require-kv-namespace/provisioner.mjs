...
// ../../../../../../../var/folders/ww/hfjqy4gs3p12j4qfrlf026lr0000gp/T/functionsRoutes-0.06279857911721054.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
...
// ../../../../wrangler2/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../wrangler2/packages/wrangler/pages/functions/template-worker.ts
...
export {
  template_worker_default as default
};
